...
To use this tool, install it from code with `make install`, `go install github.com/RahkarSanat/protoc-gen-gorm@latest` directly,
or `go get github.com/RahkarSanat/protoc-gen-gorm`.
